 ...
 * - Inserta en staging
 * - Homologa id_agente
 * - Valida si ya existe planificación del período
 * - Inserta TODO en PLANIFICACION_MONITOREO, incluso sin id_agente
 * - Muestra resultado final y pendientes sin homologar
 */
...
try {
    ...
    /*
     * 1. Limpiar staging temporal
     * OJO: solo staging, NO tabla final.
     */
    ...
    /*
     * 4. Validar duplicados por período
    ...
    if ($yaExiste > 0) {
        throw new Exception(
            'Ya existe planificación activa para el período cargado. No se insertó información para evitar duplicados.'
        );
    }

    /*
     * 5. Obtener pendientes sin id_agente
     */
    ...
    /*
     * 6. Insertar planificación final
     * IMPORTANTE:
     * Se inserta TODO, incluso registros sin id_agente.
     * Así el total planificado cuadra con el Excel.
     */
    ...
    <div class="card-body">
        ...
        <?php if (!empty($pendientes)): ?>
            <div class="alert alert-warning">
                ⚠️ La planificación fue guardada, pero existen registros sin agente homologado.
                Estos registros sí cuentan en la planificación, pero no podrán cruzarse contra ejecución real hasta corregir su homologación.
            </div>
