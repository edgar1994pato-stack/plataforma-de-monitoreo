...
/* 🔹 CASO: APROBACIÓN ADMINISTRATIVA */
if (isset($_GET['admin_consent']) && $_GET['admin_consent'] === 'True') {

    echo "<h2>Aplicación aprobada correctamente.</h2>";
    echo "<p>La aplicación ha sido autorizada en Microsoft Entra ID.</p>";
    echo "<p>Los usuarios ya pueden iniciar sesión en la plataforma utilizando su correo institucional.</p>";
...
/* 🔹 VALIDAR STATE (solo para login normal) */
$state = $_GET['state'] ?? '';
